...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self=[super initWithFrame:frame]) {
        ...
        UIButton *plusBtn = [[UIButton alloc] initWithFrame:CGRectMake((kScreenWidth-45)/2, -10, 45, 45)];
        [plusBtn setBackgroundImage:[UIImage imageNamed:@"商铺LOGO"] forState:UIControlStateNormal];
        [plusBtn setBackgroundImage:[UIImage imageNamed:@"商铺LOGO"] forState:UIControlStateHighlighted];
...
- (void)layoutSubviews
{
    ...
    if(version >= 10.00)
    {
//        NSLog(@"width is %f,height is %f",self.plusBtn.currentBackgroundImage.size.width,self.plusBtn.currentBackgroundImage.size.height);
//        self.plusBtn.centerX = kScreenWidth/2- self.plusBtn.currentBackgroundImage.size.width/2 ;
//        //调整发布按钮的中线点Y值
//        self.plusBtn.centerY = self.height -  self.plusBtn.currentBackgroundImage.size.height - 15;
