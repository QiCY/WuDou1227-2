...
+ (instancetype)shareKeyboardToolBar {
    if (keyboardToolBar == nil) {
        ...
        UIBarButtonItem *finishBtnItem = [[UIBarButtonItem alloc]initWithTitle:@"取消" style:UIBarButtonItemStyleDone target:keyboardToolBar action:@selector(resignKeyboard)];
        [finishBtnItem setTintColor:[UIColor redColor]];
