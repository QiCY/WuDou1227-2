//
//  WDPublishBianMingViewController.m
//  WuDou
//
...
#import "WDPublishBianMingViewController.h"
#import "SGImagePickerController.h"
#import "WDSecondGoodsTableVController.h"

@interface WDPublishBianMingViewController ()<UITextViewDelegate,UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource>

{
    ...
    UITableView *_categorytableView;  //分类下拉列表
...
@implementation WDPublishBianMingViewController
...
- (void)viewDidLoad {
    ...
    _categroyTextField.delegate = self;
...
- (IBAction)publishButton:(UIButton *)sender {
    ...
    [WDMainRequestManager requestPublishMyServerWithName:self.titleTextField.text region:self.areaTextField.text sate:_sate cateId:@"" contacts:self.friendsTextField.text mobile:self.phoneTextField.text media_ids:_mediaId content:self.infosTextView.text completion:^(NSString *result, NSString *error) {
